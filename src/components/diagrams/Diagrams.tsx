        ...
        >
          ...
          >
            <Avatar
              style={{
                backgroundColor:
                  getEnvironmentColor(selectedProject.environment) === "green"
                    ? "#52c41a"
                    : getEnvironmentColor(selectedProject.environment) ===
                      "orange"
                    ? "#faad14"
                    : getEnvironmentColor(selectedProject.environment) === "red"
                    ? "#ff4d4f"
                    : "#1890ff",
              }}
            >
              {getEnvironmentIcon(selectedProject.environment)}
            </Avatar>
            ...
            <Tag color={getEnvironmentColor(selectedProject.environment)}>
          ...
          <div style={{ display: "flex", gap: "16px", marginTop: "8px" }}>
            {selectedProject.regionPreference && (
              <span style={{ fontSize: "12px", color: "#8c8c8c" }}>
                <EnvironmentOutlined /> {selectedProject.regionPreference}
              </span>
            )}
            {selectedProject.createdOn && (
              <span style={{ fontSize: "12px", color: "#8c8c8c" }}>
                <CalendarOutlined /> Created: {selectedProject.createdOn}{" "}
                {selectedProject.updatedOn &&
                  " Updated: " + selectedProject.updatedOn}
              </span>
            )}
          </div>
        </div>
